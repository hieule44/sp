<div class="box-center">
  ...
  <div class="tittle-box-center">
    <h2>Kết quả tìm kiếm theo giá từ <?php echo number_fm_vnd($price_from); ?> đến <?php echo number_fm_vnd($price_to); ?></h2>
  </div>
  <div class="box-content-center product">
    ...
    <div class='product_item'>
      ...
      <p class='price'>
        <?php number_fm_vnd($sp->discount); ?>
        <?php }else{?>
        <p class='price'>
          <?php number_fm_vnd($sp->price); ?>
          <?php } ?>
          <?php if($sp->discount > 0){ ?>
