		...
		<form class="form" id="form" action="" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="username" value="<?php echo $info->username ?>" id="param_username" _autocheck="true" type="text"></span>
						<span name="name_autocheck" class="autocheck"></span>
				...
				<div class="formRow">
					...
					<div class="formRight">
						...
						<p>Nếu cập nhật mật khẩu thì điền vào</p>
					</div>
