			    ...
			    <tr class="row_<?php echo $rows->id ?>">
					...
					<td>
						<div class="image_thumb">
							<img src="<?php echo base_url('upload/news/'.$rows->image_link) ?>" height="50">
							<div class="clear"></div>
						</div>
						<a href="" class="tipS" title="" target="_blank">
						<b><?php echo $rows->title ?></b>
						</a>
						<div class="f11">Xem: <?php echo $rows->count_view ?></div>
					</td>
					
					<td class="textC"><?php echo get_date($rows->created,false) ?></td>
					<td class="option textC">						
						<a href="<?php echo admin_url('news/view/'.$rows->id) ?>" target="_blank" class="tipS" title="Xem chi tiết sản phẩm">
							<img src="<?php echo public_url('admin/') ?>images/icons/color/view.png">
						 </a>
						 <a href="<?php echo admin_url('news/edit/'.$rows->id) ?>" title="Chỉnh sửa" class="tipS">
							<img src="<?php echo public_url('admin/') ?>images/icons/color/edit.png">
						</a>
						<a href="<?php echo admin_url('news/del/'.$rows->id) ?>" title="Xóa" class="tipS verify_action">
